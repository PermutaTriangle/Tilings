...
def test_only_points():
    ...
    assert(Tiling({(0,0): Block.point, (1,0): Block.point}).rank() == 1)
    assert(Tiling({(0,0): Block.point, (0,1): Block.point, (1,0): Block.point}).rank() == 1)
...
def test_point_point_clash():
    assert(Tiling({(0,0): Block.point, (1,0): Block.point, (2,2): Block.increasing}).rank() == 3)

def test_set_point_clash():
    assert(Tiling({(0,0): Block.point, (0,1): Block.decreasing}).rank() == 4)

def test_point_L_clash():
    assert(Tiling({(0,0): Block.point, (0,1): Block.point, (1,0): Block.point, (2,2): Block.increasing}).rank() == 5)
