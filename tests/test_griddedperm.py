...
def bigob():
    ...
    return GriddedPerm(Perm((3, 1, 6, 8, 0, 2, 9, 5, 7, 4)),
...
def test_isolated_point():
    ...
    assert (sorted(ob.isolate_point_row((1, 1))) ==
            [GriddedPerm(Perm((0, 1)),
                         [(1, 4), (1, 4)])])
    ob = GriddedPerm(Perm((3, 2, 0, 1)),
                     [(0, 1), (0, 1), (1, 0), (2, 1)])
    assert (sorted(ob.isolate_point_col((1, 1))) ==
            [GriddedPerm(Perm((3, 2, 0, 1)),
                         [(0, 1), (0, 1), (1, 0), (4, 1)]),
             GriddedPerm(Perm((3, 2, 0, 1)),
                         [(0, 1), (0, 1), (3, 0), (4, 1)])])
    assert (sorted(ob.isolate_point_row((1, 1))) ==
...
def test_rotatation(bigob):
    ...
    assert bigob.rotate90(partial(rotate90_cell, 17)) == GriddedPerm(
...
def test_inverse(bigob):
    ...
    assert bigob.inverse(inverse_cell) == GriddedPerm(
...
def test_complement(bigob):
    ...
    assert bigob.complement(complement_cell) == GriddedPerm(
...
def test_reverse(bigob):
    ...
    assert bigob.reverse(reverse_cell) == GriddedPerm(
