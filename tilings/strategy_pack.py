...
class TileScopePack(StrategyPack):
    ...
    def add_initial(self, strategy: Strategy, name_ext: str = "") -> "TileScopePack":
        """
    ...
    def add_inferral(self, strategy: Strategy, name_ext: str = "") -> "TileScopePack":
        """
    ...
    def add_verification(
        self, strategy: Strategy, name_ext: str = ""
    ) -> "TileScopePack":
        """
